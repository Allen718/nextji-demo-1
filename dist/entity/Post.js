...
var Post = (_dec = (0, _typeorm.Entity)('posts'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('varchar'), _dec4 = (0, _typeorm.Column)('text'), _dec5 = (0, _typeorm.OneToMany)(function (type) {
  ...
  return user.posts;
}), _dec7 = (0, _typeorm.CreateDateColumn)(), _dec8 = (0, _typeorm.UpdateDateColumn)(), _dec(_class = (_class2 = /*#__PURE__*/(0, _createClass2["default"])(function Post() {
  ...
  (0, _initializerDefineProperty2["default"])(this, "comments", _descriptor4, this);
  (0, _initializerDefineProperty2["default"])(this, "author", _descriptor5, this);
  ...
  writable: true,
  initializer: null
}), _descriptor5 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "author", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
